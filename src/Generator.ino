...
unsigned long SLEEP_TIME = 3600000;     // Laufzeit der Loop
...
void loop() {
 ...
 // --- Spannungsmessung
     ...
     // Formel = (10bit-Wert) * (Ref.-Spg.) / (10bit) * (Spg.-Teiler-Wert)
     float batteryV = sensorValue * 5.0 /1024.0 / 0.3197; 
